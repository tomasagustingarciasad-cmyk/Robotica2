...
% En el Robotics Toolbox, definiremos los eslabones individualmente para 
% poder asignarles sus propiedades de masa (m) y centro de masa (r).
...
L(1).r = [0, 0, L1/2]; % Asumimos longitud en Z para el pedestal
L(2).r = [L2/2, 0, 0];
L(3).r = [L3/2, 0, 0];
L(4).r = [L4/2, 0, 0];
