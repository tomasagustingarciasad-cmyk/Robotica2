...
L1 = 0.1; % Altura desde la base hasta la segunda articulación
L2 = 0.15; % Longitud del brazo principal
L3 = 0.15; % Longitud del antebrazo
L4 = 0; % Longitud del efector final (Reemplazar por valor real)
